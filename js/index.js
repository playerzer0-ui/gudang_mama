...
function addRow() {
    ...
    newRow.innerHTML = `
        <td>${rowCount}</td>
        <td><input type="text" name="kd[]" placeholder="di isi" class="productCode" oninput="applyAutocomplete(this)" required></td>
    ...
    // applyAutocomplete($(newRow).find('.productCode'));
}

// $(document).ready(function() {
//     // Apply autocomplete to existing input fields generated by PHP
